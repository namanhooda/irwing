...
class BilateralEngagementReportController extends Controller
{
    //
    ...
    public function index()
    {
        ...
        return view('admin.bilateral_engagement_report.index', compact('engagements'));
    }

    public function create()
    {
        $countries = Country::orderBy('name')->get();
        return view('admin.bilateral_engagement_report.create', compact('countries'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.bilateral_engagement_report.edit', compact('engagement', 'countries'));
    }
    ...
    {
        return Excel::download(new BilateralEngagementExport, 'Bilateral_engagements.xlsx');
    }
